...
import type {Hazard, RouteProgress, SegmentCache, RouteHazard} from '../types';
...
export class TripService {
  ...
  private readonly ROUTE_CORRIDOR_METERS = 75; // Increased to 75m buffer for better coverage
